...
extern "C" uint probe_p08m_irr_13(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    uint __out{};
...
extern "C" float4x3 probe_p08m_irr_14(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data, world_space_data> __i;
    float4x3 __out{};
...
extern "C" bool probe_p08m_irr_15(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    bool __out{};
...
extern "C" void probe_p08m_ift_16(visible_function_table<void(uint)> vft0) {
...
extern "C" compute_pipeline_state probe_p08m_type_17(compute_pipeline_state p) { return p; }

// builtin=__metal_depth_stencil_state_t cls=type_passthrough
extern "C" depth_stencil_state probe_p08m_type_18(depth_stencil_state p) { return p; }

// builtin=__metal_intersection_function_table_t cls=type_passthrough
extern "C" intersection_function_table<instancing, triangle_data> probe_p08m_type_19(intersection_function_table<instancing, triangle_data> p) { return p; }

// builtin=__metal_intersection_result_t cls=type_passthrough
extern "C" intersection_result<instancing, triangle_data> probe_p08m_type_20(intersection_result<instancing, triangle_data> p) { return p; }

// builtin=__metal_render_pipeline_state_t cls=type_passthrough
extern "C" render_pipeline_state probe_p08m_type_21(render_pipeline_state p) { return p; }

// builtin=__metal_tensor_t cls=type_passthrough
extern "C" tensor<device float, extents<int, 4, 8>> probe_p08m_type_22(tensor<device float, extents<int, 4, 8>> p) { return p; }

// builtin=__metal_visible_function_table_t cls=type_passthrough
extern "C" visible_function_table<void(uint)> probe_p08m_type_23(visible_function_table<void(uint)> p) { return p; }
