...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readnone willreturn
define float @probe_p11m_divide_21() local_unnamed_addr #1 {
...
define void @probe_p11m_winding_29(%struct._command_buffer_t addrspace(1)* nocapture %0) local_unnamed_addr #2 {
  tail call void @air.set_front_facing_winding_render_command(%struct._command_buffer_t addrspace(1)* nocapture %0, i32 0, i32 1) #4
  ret void
}

; Function Attrs: mustprogress nounwind willreturn
define void @probe_p11m_setps_r_30(%struct._command_buffer_t addrspace(1)* nocapture %0, %struct._render_pipeline_state_t addrspace(1)* %1) local_unnamed_addr #2 {
  tail call void @air.set_pipeline_state_render_command(%struct._command_buffer_t addrspace(1)* nocapture %0, i32 0, %struct._render_pipeline_state_t addrspace(1)* readonly %1) #4
  ret void
}

; Function Attrs: mustprogress nounwind willreturn
define void @probe_p11m_setps_c_31(%struct._command_buffer_t addrspace(1)* nocapture %0, %struct._compute_pipeline_state_t addrspace(1)* %1) local_unnamed_addr #2 {
  tail call void @air.set_pipeline_state_compute_command(%struct._command_buffer_t addrspace(1)* nocapture %0, i32 0, %struct._compute_pipeline_state_t addrspace(1)* readonly %1) #4
  ret void
}

; Function Attrs: mustprogress nounwind willreturn
declare void @air.set_front_facing_winding_render_command(%struct._command_buffer_t addrspace(1)* nocapture, i32, i32) local_unnamed_addr #3

; Function Attrs: mustprogress nounwind willreturn
declare void @air.set_pipeline_state_render_command(%struct._command_buffer_t addrspace(1)* nocapture, i32, %struct._render_pipeline_state_t addrspace(1)* readonly) local_unnamed_addr #3

; Function Attrs: mustprogress nounwind willreturn
declare void @air.set_pipeline_state_compute_command(%struct._command_buffer_t addrspace(1)* nocapture, i32, %struct._compute_pipeline_state_t addrspace(1)* readonly) local_unnamed_addr #3
...
!15 = !{!"/Users/runner/metal_probe/p11/P11M/probe.metal"}
