...
extern "C" void probe_p08m_rc_0(device const uint * p0) {
    command_buffer __cb;
...
// DISABLED_BY_LOOP extern "C" uint probe_p08m_iq_1(void) {
...
// DISABLED_BY_LOOP extern "C" uint probe_p08m_iq_2(void) {
// DISABLED_LINE     ray __r;
// DISABLED_LINE     intersection_query<instancing, triangle_data> __q;
...
extern "C" float probe_p08m_irr_4(instance_acceleration_structure __as) {
    ray __r;
...
extern "C" uint probe_p08m_irr_7(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    uint __out{};
...
extern "C" float4x3 probe_p08m_irr_8(instance_acceleration_structure __as) {
    ray __r;
...
extern "C" uint probe_p08m_irr_9(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    uint __out{};
...
extern "C" float3 probe_p08m_irr_10(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    float3 __out{};
...
extern "C" float probe_p08m_irr_11(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    float __out{};
...
extern "C" float3 probe_p08m_irr_12(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    float3 __out{};
...
extern "C" float2 probe_p08m_irr_13(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    float2 __out{};
...
// DISABLED_BY_LOOP extern "C" uint probe_p08m_irr_14(instance_acceleration_structure __as) {
// DISABLED_LINE     ray __r;
...
extern "C" uint probe_p08m_irr_15(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    uint __out{};
...
extern "C" float4x3 probe_p08m_irr_16(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data, world_space_data> __i;
    float4x3 __out{};
...
extern "C" bool probe_p08m_irr_17(instance_acceleration_structure __as) {
    ray __r;
    intersector<instancing, triangle_data> __i;
    bool __out{};
...
extern "C" void probe_p08m_ift_18(visible_function_table<void(uint)> vft0) {
...
extern "C" compute_pipeline_state probe_p08m_type_19(compute_pipeline_state p) { return p; }

// builtin=__metal_depth_stencil_state_t cls=type_passthrough
extern "C" depth_stencil_state probe_p08m_type_20(depth_stencil_state p) { return p; }

// builtin=__metal_intersection_function_table_t cls=type_passthrough
extern "C" intersection_function_table<instancing, triangle_data> probe_p08m_type_21(intersection_function_table<instancing, triangle_data> p) { return p; }

// builtin=__metal_intersection_result_t cls=type_passthrough
extern "C" intersection_result<instancing, triangle_data> probe_p08m_type_22(intersection_result<instancing, triangle_data> p) { return p; }

// builtin=__metal_render_pipeline_state_t cls=type_passthrough
extern "C" render_pipeline_state probe_p08m_type_23(render_pipeline_state p) { return p; }

// builtin=__metal_tensor_t cls=type_passthrough
extern "C" tensor<float, extents<int, 4, 8>> probe_p08m_type_24(tensor<float, extents<int, 4, 8>> p) { return p; }

// builtin=__metal_visible_function_table_t cls=type_passthrough
extern "C" visible_function_table<void(uint)> probe_p08m_type_25(visible_function_table<void(uint)> p) { return p; }
