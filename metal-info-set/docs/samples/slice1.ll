...
target triple = "air64_v25-apple-macosx13.0.0"

%"struct.(anonymous namespace)::VertexTraceBuffer.4241" = type { %"struct.(anonymous namespace)::TraceBuffer.4240", i32, i32, i32, [1 x i32] }
%"struct.(anonymous namespace)::TraceBuffer.4240" = type { %"struct.metal::_atomic.4239", i32, %"struct.metal::_atomic.4239" }
%"struct.metal::_atomic.4239" = type { i32 }
...
25:                                               ; preds = %22, %17
  ...
  %28 = getelementptr inbounds %"struct.(anonymous namespace)::VertexTraceBuffer.4241", ptr addrspace(1) %7, i64 0, i32 4, i64 %27
...
26:                                               ; preds = %23, %18
  ...
  %29 = getelementptr inbounds %"struct.(anonymous namespace)::VertexTraceBuffer.4241", ptr addrspace(1) %8, i64 0, i32 4, i64 %28
