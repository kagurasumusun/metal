...
## Section Implementer's Guide & Advanced Dynamic Linkage Specifications for SECTION18_SAMPLER_CONSTEXPR_MAPPING

When building a production-grade clang/llvm compiler backend targeting SECTION18_SAMPLER_CONSTEXPR_MAPPING:
