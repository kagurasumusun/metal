...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_0(texture1d_array<uint, access::read_write> t) { t.atomic_max(0u, 0u, ulong4(0ul)); }
#else
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_1(texture1d<uint, access::read_write> t) { t.atomic_max(0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_2(texture2d_array<uint, access::read_write> t) { t.atomic_max(uint2(0u), 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_3(texture2d<uint, access::read_write> t) { t.atomic_max(uint2(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_4(texture3d<uint, access::read_write> t) { t.atomic_max(uint3(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_5(texture_buffer<uint, access::read_write> t) { t.atomic_max(0u, ulong4(0ul)); }
#else
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_6(texturecube_array<uint, access::read_write> t) { t.atomic_max(uint2(0u), 0u, 0u, ulong4(0ul)); }
#else
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_7(texturecube<uint, access::read_write> t) { t.atomic_max(uint2(0u), 0u, ulong4(0ul)); }
#else
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_8(texture1d_array<uint, access::read_write> t) { t.atomic_min(0u, 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_9(texture1d<uint, access::read_write> t) { t.atomic_min(0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_10(texture2d_array<uint, access::read_write> t) { t.atomic_min(uint2(0u), 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_11(texture2d<uint, access::read_write> t) { t.atomic_min(uint2(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_12(texture3d<uint, access::read_write> t) { t.atomic_min(uint3(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_13(texture_buffer<uint, access::read_write> t) { t.atomic_min(0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_BUFFER__|__HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_14(texturecube_array<uint, access::read_write> t) { t.atomic_min(uint2(0u), 0u, 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_CUBE_ARRAY__|__HAVE_TEXTURE_CUBE_ARRAY_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_15(texturecube<uint, access::read_write> t) { t.atomic_min(uint2(0u), 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_CUBE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif

// builtin=__metal_get_height_depth_2d_t cls=_depth2d
// DISABLED_BY_LOOP extern "C" uint probe_p06m_get_height_16(depth2d<float> d) { return d.get_height(0u); }

// builtin=__metal_get_num_samples_depth_2d_ms_t cls=_depth2d_ms
// DISABLED_BY_LOOP extern "C" uint probe_p06m_get_num_samples_17(depth2d<float> d) { return d.get_num_samples(); }

// builtin=__metal_get_width_depth_2d_t cls=_depth2d
extern "C" uint probe_p06m_get_width_18(depth2d<float> d) { return d.get_width(0u); }

// builtin=__metal_read_depth_2d_array_t cls=_depth2d_array_read
extern "C" float probe_p06m_read_19(depth2d_array<float> d) { return d.read(uint2(0u), 0u, 0u); }
...
extern "C" sparse_color<float> probe_p06m_sparse_read_20(depth2d_ms_array<float> d) { return d.sparse_read(uint2(0u), 0u, 0u); }
#else
...
extern "C" float probe_p06m_read_21(depth2d<float> d) { return d.read(uint2(0u), 0u); }
...
extern "C" sparse_color<float> probe_p06m_sparse_read_22(depthcube_array<float> d) { return d.sparse_read(uint2(0u), 0u, 0u, 0u); }
#else
...
extern "C" sparse_color<float> probe_p06m_sparse_read_23(depthcube<float> d) { return d.sparse_read(uint2(0u), 0u, 0u); }
#else
...
extern "C" float probe_p06m_sample_compare_24(depth2d_array<float> d, sampler s) { return d.sample_compare(s, float2(1.0f), 0u, 1.0f, int2(0)); }
...
extern "C" sparse_color<float> probe_p06m_sparse_sample_compare_25(depth2d_array<float> d, sampler s) { return d.sparse_sample_compare(s, float2(1.0f), 0u, 1.0f, gradient2d(float2(0.5f), float2(0.5f)), int2(0)); }
#else
...
extern "C" float probe_p06m_sample_compare_26(depth2d<float> d, sampler s) { return d.sample_compare(s, float2(1.0f), 1.0f, int2(0)); }
...
extern "C" sparse_color<float> probe_p06m_sparse_sample_compare_27(depth2d<float> d, sampler s) { return d.sparse_sample_compare(s, float2(1.0f), 1.0f, gradient2d(float2(0.5f), float2(0.5f)), min_lod_clamp(1.0f), int2(0)); }
#else
...
extern "C" sparse_color<float> probe_p06m_sparse_sample_compare_28(depthcube_array<float> d, sampler s) { return d.sparse_sample_compare(s, float3(1.0f), 0u, 1.0f, bias(1.0f), min_lod_clamp(1.0f)); }
#else
...
extern "C" sparse_color<float> probe_p06m_sparse_sample_compare_29(depthcube_array<float> d, sampler s) { return d.sparse_sample_compare(s, float3(1.0f), 0u, 1.0f, gradientcube(float3(0.5f), float3(0.5f)), min_lod_clamp(1.0f)); }
#else
...
extern "C" float probe_p06m_sample_compare_30(depthcube<float> d, sampler s) { return d.sample_compare(s, float3(1.0f), 1.0f); }
...
extern "C" sparse_color<float> probe_p06m_sparse_sample_compare_31(depthcube<float> d, sampler s) { return d.sparse_sample_compare(s, float3(1.0f), 1.0f, gradientcube(float3(0.5f), float3(0.5f)), min_lod_clamp(1.0f)); }
#else
...
extern "C" float probe_p06m_sample_32(depth2d<float> d, sampler s) { return d.sample(s, float2(1.0f), gradient2d(float2(0.5f), float2(0.5f)), int2(0)); }
...
extern "C" sparse_color<float> probe_p06m_sparse_sample_33(depthcube_array<float> d, sampler s) { return d.sparse_sample(s, float3(1.0f), 0u, bias(1.0f), min_lod_clamp(1.0f)); }
#else
...
extern "C" sparse_color<float> probe_p06m_sparse_sample_34(depthcube_array<float> d, sampler s) { return d.sparse_sample(s, float3(1.0f), 0u, gradientcube(float3(0.5f), float3(0.5f)), min_lod_clamp(1.0f)); }
#else
// guard __HAVE_DEPTH_CUBE_ARRAY__|__HAVE_MESH__|__HAVE_SPARSE_TEXTURES__|__HAVE_MIN_LOD_CLAMP__ 無効ターゲットでは無効化
#endif

// builtin=__metal_sample_texture_cube_t_grad cls=_texturecube_sample
// DISABLED_BY_LOOP extern "C" float4 probe_p06m_sample_35(texturecube<float> t, sampler s) { return t.sample(s, float3(1.0f), gradientcube(float3(0.5f), float3(0.5f))); }
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_write_36(texturecube_array<float> t) { t.write(float4(1.0f), uint2(0u), 0u, 0u, 0u); }
#else
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_write_37(texturecube<float> t) { t.write(float4(1.0f), uint2(0u), 0u, 0u); }
#else
