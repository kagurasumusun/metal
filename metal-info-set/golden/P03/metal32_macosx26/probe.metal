...
#else
// NOTE: __HAVE_DIVIDE__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
...
#else
// NOTE: __HAVE_FMAX3__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
...
#else
// NOTE: __HAVE_FMEDIAN3__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
...
#else
// NOTE: __HAVE_FMIN3__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
