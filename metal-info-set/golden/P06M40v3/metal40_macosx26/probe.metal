...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_8(texture1d_array<uint, access::read_write> t) { t.atomic_max(0u, 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_9(texture1d<uint, access::read_write> t) { t.atomic_max(0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_10(texture2d_array<uint, access::read_write> t) { t.atomic_max(uint2(0u), 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_11(texture2d<uint, access::read_write> t) { t.atomic_max(uint2(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_12(texture3d<uint, access::read_write> t) { t.atomic_max(uint3(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_13(texture_buffer<uint, access::read_write> t) { t.atomic_max(0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_BUFFER__|__HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_14(texturecube_array<uint, access::read_write> t) { t.atomic_max(uint2(0u), 0u, 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_CUBE_ARRAY__|__HAVE_TEXTURE_CUBE_ARRAY_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_max_15(texturecube<uint, access::read_write> t) { t.atomic_max(uint2(0u), 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_CUBE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_16(texture1d_array<uint, access::read_write> t) { t.atomic_min(0u, 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_17(texture1d<uint, access::read_write> t) { t.atomic_min(0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_18(texture2d_array<uint, access::read_write> t) { t.atomic_min(uint2(0u), 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_19(texture2d<uint, access::read_write> t) { t.atomic_min(uint2(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_20(texture3d<uint, access::read_write> t) { t.atomic_min(uint3(0u), ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_21(texture_buffer<uint, access::read_write> t) { t.atomic_min(0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_BUFFER__|__HAVE_TEXTURE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_22(texturecube_array<uint, access::read_write> t) { t.atomic_min(uint2(0u), 0u, 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_CUBE_ARRAY__|__HAVE_TEXTURE_CUBE_ARRAY_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_atomic_min_23(texturecube<uint, access::read_write> t) { t.atomic_min(uint2(0u), 0u, ulong4(0ul)); }
#else
// guard __HAVE_TEXTURE_CUBE_RELAXED_ORDER_ATOMIC__ 無効ターゲットでは無効化
#endif
...
// DISABLED_BY_LOOP extern "C" uint probe_p06m_get_height_28(depth2d<float> d) { return d.get_height(0u); }

// builtin=__metal_get_num_samples_depth_2d_ms_t cls=_depth2d_ms
// DISABLED_BY_LOOP extern "C" uint probe_p06m_get_num_samples_29(depth2d<float> d) { return d.get_num_samples(); }
...
// DISABLED_BY_LOOP extern "C" float4 probe_p06m_sample_47(texturecube<float> t, sampler s) { return t.sample(s, float3(1.0f), gradientcube(float3(0.5f), float3(0.5f))); }
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_write_48(texturecube_array<float> t) { t.write(float4(1.0f), uint2(0u), 0u, 0u, 0u); }
#else
...
// DISABLED_BY_LOOP extern "C" void probe_p06m_write_49(texturecube<float> t) { t.write(float4(1.0f), uint2(0u), 0u, 0u); }
#else
