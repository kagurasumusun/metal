...
## Section Implementer's Guide & Advanced Dynamic Linkage Specifications for SECTION12_API_MAPPING_MATRIX_ATOMICS_SYNC_COOP

When building a production-grade clang/llvm compiler backend targeting SECTION12_API_MAPPING_MATRIX_ATOMICS_SYNC_COOP:
