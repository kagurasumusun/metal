...
## Section Implementer's Guide & Advanced Dynamic Linkage Specifications for SECTION15_LLVM_IR_TO_AIR_OPCODES

When building a production-grade clang/llvm compiler backend targeting SECTION15_LLVM_IR_TO_AIR_OPCODES:
