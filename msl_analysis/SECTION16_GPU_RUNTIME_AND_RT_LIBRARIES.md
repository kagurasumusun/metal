...
## Section Implementer's Guide & Advanced Dynamic Linkage Specifications for SECTION16_GPU_RUNTIME_AND_RT_LIBRARIES

When building a production-grade clang/llvm compiler backend targeting SECTION16_GPU_RUNTIME_AND_RT_LIBRARIES:
