...
#else
// NOTE: __HAVE_INTEGER_BIT_EDIT_FUNCTIONS__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
...
#else
// NOTE: __HAVE_MAX3__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
...
#else
// NOTE: __HAVE_MEDIAN3__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
...
#else
// NOTE: __HAVE_MIN3__ 無効ターゲットのため wrapper 無効化 (この builtin は対応ターゲットで別途 probe)
#endif
